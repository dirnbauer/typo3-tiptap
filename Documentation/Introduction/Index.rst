...
TYPO3 TipTap replaces the default editor widget with a TipTap-driven backend component while staying close to TYPO3's existing RTE configuration model.
